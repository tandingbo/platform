package com.tdb.base.commons.utils.dbupdate.dao.impl;
...
import com.zjhc.commons.db.dao.EntityDaoSupport;
import com.zjhc.commons.exception.DaoAccessException;
import com.zjhc.commons.utils.dbupdate.DbVersion;
import com.zjhc.commons.utils.dbupdate.SqlScriptReader;
import com.zjhc.commons.utils.dbupdate.dao.DbVersionDao;
...
public class DbVersionDaoImpl extends EntityDaoSupport<DbVersion> implements DbVersionDao {
	...
	/**
	 * @see com.zjhc.DbVersionDao#getCurrentVersion()
	 * 创建日期：2013-1-7
	 * 修改说明：
	 * @author niezhegang
	 */
	...
	/**
	 * @see com.zjhc.DbVersionDao#updateToNextVersion()
	 * 创建日期：2013-1-7
	 * 修改说明：
	 * @author niezhegang
	 */
	...
	/**
	 * @see com.zjhc.DbVersionDao#isInitVersion()
	 * 创建日期：2013-1-7
	 * 修改说明：
	 * @author niezhegang
	 */
	...
	/**
	 * @see com.zjhc.DbVersionDao#executeOneSQLFile(File)
	 * 创建日期：2013-1-8
	 * 修改说明：
	 * @author niezhegang
	 */
	...
	/**
	 * @see com.zjhc.DbVersionDao#getVersionDatabaseTypeName()
	 * 创建日期：2013-1-8
	 * 修改说明：
	 * @author niezhegang
	 */
